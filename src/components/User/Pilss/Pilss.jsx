...
import Style from "./Pilss.module.css"
import  "./Pilss.scss"


class Pilss extends Component {
  state = {
    items: {
      default: "1",
    }
      ...
      <MDBContainer className="mt-4">
          ...
          <MDBNav className="mt-5 nav-pills">
                <MDBNavItem>
                  ...
                  <h5>LEASE <span className="text-green "> IPV4</span></h5>
                  </MDBNavLink>
                </MDBNavItem>
                <MDBNavItem>
                  <MDBNavLink link to="#" active={this.state.items["default"] === "2"} onClick={this.togglePills("default", "2")} >
                  <h5>LEASE<span className="text-green "> SER</span>VERS</h5>
                  </MDBNavLink>
                </MDBNavItem>
                </MDBNav>
              <MDBNav className="mt-0 nav-pills">
                <MDBNavItem>
                  ...
                  <h5><span className="text-green "> CO</span>-LOCATION</h5>
                  </MDBNavLink>
                </MDBNavItem>
                <MDBNavItem>
                  <MDBNavLink link to="#" active={this.state.items["default"] === "4"} onClick={this.togglePills("default", "4")} >
                  <h5>DA<span className="text-green ">TA </span>ANALYTICS</h5>
              ...
              <MDBTabContent  className={Style.tabContent}  activeItem={this.state.items["default"]}>
                <MDBTabPane  tabId="1">
                  <p>
